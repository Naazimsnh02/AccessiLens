...
(function () {
      ...
      <div class="accessilens-modal">
        ...
        <div class="accessilens-modal-body">
          <div class="accessilens-original-text">
            <div class="accessilens-original-label">Original Text</div>
        ...
        <div class="accessilens-modal-footer">
          <button class="accessilens-modal-btn accessilens-modal-btn-secondary" id="accessilens-copy-btn">
            Copy Response
          </button>
          <button class="accessilens-modal-btn accessilens-modal-btn-primary" id="accessilens-replace-btn">
            Replace Original
          </button>
        </div>
      </div>
    `;
        ...
        overlay.querySelector('#accessilens-replace-btn').addEventListener('click', replaceWithResponse);
    ...
    function handleTooltipAction(action) {
        ...
        switch (action) {
            case 'simplify':
                callAI('simplify', selectedText, 'Simplified Text');
                break;
            case 'explain':
                callAI('explain', selectedText, 'Explanation');
                break;
            case 'define':
                callAI('define', selectedText, 'Definition');
                break;
            case 'speak':
